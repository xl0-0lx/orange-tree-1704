...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/orange-tree-1704
```

A live public deployment of this template is available at [https://orange-tree-1704.templates.workers.dev](https://orange-tree-1704.templates.workers.dev)
